  ...
  head: () => ({
    meta: [
      ...
      { title: "Sidekick — Live AI Game Coach" },
      {
        name: "description",
        content:
          "Sidekick watches your gameplay in real time, identifies the game, and tells you what to do next.",
      },
      { property: "og:title", content: "Sidekick — Live AI Game Coach" },
      {
        property: "og:description",
        content:
          "Real-time AI that watches your gameplay and calls your next move.",
      },
